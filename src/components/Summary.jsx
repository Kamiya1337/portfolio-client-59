  ...
  return (
    <div className="min-h-screen bg-paper">
      ...
      <main className="mx-auto max-w-5xl px-6 pb-28 sm:px-8">
        ...
        <section className="mt-24 border border-border-dark bg-obsidian p-8 text-ivory sm:p-12"><p className="dark-editorial-label">Academic Integrity</p><h2 className="mt-4 text-3xl font-black tracking-[-0.04em]">Cam kết Liêm chính Học thuật</h2><p className="mt-7 whitespace-pre-line text-base italic leading-8 text-muted-light">{`Em, Chảo Lở Mẩy, cam kết rằng các báo cáo và nội dung trong portfolio này phản ánh đúng quá trình học tập và thực hành của bản thân. Trong quá trình làm, em có sử dụng AI như một công cụ hỗ trợ, chủ yếu để gợi ý cách trình bày, hỗ trợ sửa code và kiểm tra lại một số phần nội dung.
